...
# 状态常量
STATUS_WAITTING = u'等待成交'
STATUS_PROCESSING = u'撤单处理中'
...
# 成交状态
TRADER_STATUS_NO_DEAL = '未成交'
TRADER_STATUS_PART_DEAL = '部分成交'
TRADER_STATUS_DEAL = '已完成'
TRADER_STATUS_CANEL = '已取消'
TRADER_STATUS_PROCESSING = '撤单处理中'